...
readonly OPENBSD_EXPECTED_HASH="ff0ba96ed553de9fa151abd26369fae2fef871a90c0941e7585c9cb8e56fb9b0"
readonly OPENBSD_CHECKSUM_URL="https://cdn.openbsd.org/pub/OpenBSD/7.8/amd64/SHA256"
...
download_openbsd_iso() {
    ...
    if [[ "$actual_hash" != "$OPENBSD_EXPECTED_HASH" ]]; then
        log_error "Expected: $OPENBSD_EXPECTED_HASH"
        log_error "Got:      $actual_hash"
        die "Checksum mismatch: expected $OPENBSD_EXPECTED_HASH, got $actual_hash"
    fi
    log_info "Checksum OK"
}
